...
void Essai2()
{
	...
	{
		cout << "!!! InvalidDateException !!!" << endl;
		cout << de.getMessage() << " (" << de.getFormat() << ")." << endl;
	}
...
void Essai3()
{
	...
	catch(InvalidRaceSizeException se)
	{
		cout << "!!! InvalidRaceSizeException !!!" << endl;
		cout << se.getMessage() << " (" << se.getRaceLength() << ")" << endl;
	}
